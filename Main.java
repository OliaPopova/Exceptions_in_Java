...
public class Main {
    ...
    public static void makeRecord() throws Exception {
        ...
        try (BufferedReader bf = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            throw new FileSystemException("Произошла ошибка при работе с консолью");
        }

        String[] array = text.split(" ");
        if (array.length != 6) {
            throw new FileSystemException("Введено неверное количество параметров");
        }
        ...
        String filePath = "files/" + surname.toLowerCase() + ".txt"; 
